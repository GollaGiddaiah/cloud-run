pipeline {
    ...
    environment {
        PROJECT_ID = 'bunny-project-444905'  // GCP Project ID
        GOOGLE_APPLICATION_CREDENTIALS = credentials('gcp-service-account')  // Service account credentials
        DOCKER_HUB_CREDENTIALS_USR = 'bunnygcpdevops'  // Your Docker Hub username
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git branch: 'main', url: 'https://github.com/saleemafroze/cloudrun-new.git'
            }
        }
